...
export default function Home() {
  ...
  return <>
    <section className="hero shell"><div className="hero-main"><Image src={hero} alt="Fresh groceries arranged for a weekly shop" fill priority sizes="(max-width: 900px) 100vw, 70vw" /><div className="hero-copy"><span className="pill">THIS WEEK AT NOVA MART</span><h1>Big savings for<br />everyday living.</h1><p>Groceries, home essentials, electronics and more - quality products at prices made for everyday life.</p><div><Link className="primary-btn" href="/shop">Shop today&apos;s deals <ArrowRight /></Link><Link className="secondary-btn" href="#categories">Explore categories</Link></div></div></div><div className="hero-side"><Link href="/offers" className="side-offer tech-offer"><Image src="https://images.unsplash.com/photo-1604719312566-8912e9227c6a?auto=format&fit=crop&w=900&q=85" alt="Colourful grocery products on store shelves" fill sizes="(max-width: 800px) 50vw, 28vw" /><span>LIVE OFFERS</span><h2>Smart shopping.<br />Better value.</h2><b>See today&apos;s offers -&gt;</b></Link><Link href="/stores" className="side-offer home-offer"><Image src="https://images.unsplash.com/photo-1578916171728-46686eac8d58?auto=format&fit=crop&w=900&q=85" alt="A bright modern supermarket aisle" fill sizes="(max-width: 800px) 50vw, 28vw" /><span>CHOOSE YOUR STORE</span><h2>Shop what&apos;s<br />near you.</h2><b>Find a store -&gt;</b></Link></div></section>
    <div className="service-strip shell"><span><Truck />Free delivery over NPR 9,999</span><span><PackageCheck />Pickup ready in 2 hours</span><span><ShieldCheck />Easy 7-day returns</span><span><Tags />Prices you can trust</span></div>
