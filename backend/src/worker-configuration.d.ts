/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false src/worker-configuration.d.ts` (hash: 8b20c2b4382f73fa0ae86d8300b70a45)
...
interface __BaseEnv_Env {
	...
	CORS_ORIGIN: string;
	APP_URL: string;
	ENABLE_ADMIN_API: string;
	ENABLE_ELECTRONIC_PAYMENTS: string;
	ENABLE_ADVANCED_ANALYTICS: string;
	ENABLE_EXTERNAL_TAX_INTEGRATION: string;
	ENABLE_RETURNS: string;
	ENABLE_PROMOTION_ENGINE: string;
	ENABLE_CUSTOMER_SEGMENTS: string;
	ENABLE_OFFLINE_SYNC: string;
	ENABLE_HARDWARE_DEVICES: string;
	ENABLE_EXTERNAL_CMS_CDN: string;
	ENABLE_FISCAL_COMPLIANCE_INTEGRATION: string;
	JWT_ISSUER: string;
	JWT_AUDIENCE: string;
	DATABASE_RUNTIME_ROLE: string;
	DATABASE_MIGRATION_ROLE: string;
	DATABASE_SSL: string;
	REQUIRE_LEAST_PRIVILEGE_DATABASE_ROLE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACTIVE_MARKET" | "DEFAULT_COUNTRY_CODE" | "DEFAULT_CURRENCY_CODE" | "DEFAULT_LOCALE" | "DEFAULT_TIMEZONE" | "DEFAULT_TAX_REGIME" | "CORS_ORIGIN" | "APP_URL" | "ENABLE_ADMIN_API" | "ENABLE_ELECTRONIC_PAYMENTS" | "ENABLE_ADVANCED_ANALYTICS" | "ENABLE_EXTERNAL_TAX_INTEGRATION" | "ENABLE_RETURNS" | "ENABLE_PROMOTION_ENGINE" | "ENABLE_CUSTOMER_SEGMENTS" | "ENABLE_OFFLINE_SYNC" | "ENABLE_HARDWARE_DEVICES" | "ENABLE_EXTERNAL_CMS_CDN" | "ENABLE_FISCAL_COMPLIANCE_INTEGRATION" | "JWT_ISSUER" | "JWT_AUDIENCE" | "DATABASE_RUNTIME_ROLE" | "DATABASE_MIGRATION_ROLE" | "DATABASE_SSL" | "REQUIRE_LEAST_PRIVILEGE_DATABASE_ROLE" | "DATABASE_POOL_MAX">> {}
}
